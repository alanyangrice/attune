// Stub Spotify (design.md §8 arrives later; same port). A tiny canned
// catalog with vibe tags for search, and a fake player that "plays" tracks
// on a 1 s clock, emitting the same events the real player.ts poll loop
// will emit: "trackchange" and "ending" (at T − trackEndLeadSec).
