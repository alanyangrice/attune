...
description: Use when a developer wants to measure vitals (pulse, breathing,
  ...) from video with the SmartSpectra SDK — the API model, getting a key,
  choosing metrics, or integrating the SDK on any platform.
---
